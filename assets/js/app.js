...
const APP_VERSION = 'ALARMAS-LUCIA-v2.3-AVISO-INMOVILIDAD-ESCALADO-20260712';
...
function setupEvents(){
  ...
  on('soundSelect', 'change', () => { state.settings.sound = $('soundSelect').value; saveSettings(); syncNativeImmobilityMonitors(); });
